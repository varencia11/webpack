let swiper, swiper1, swiper2;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        menuImage.addEventListener('click', function(event) {
            ...
            pageContent.classList.add('blureffect'); // Blur the background when menu opens
        });
        ...
        document.addEventListener('click', function(event) {
            if (!sideFeed.contains(event.target) && !menuImage.contains(event.target)) {
                ...
                pageContent.classList.remove('blureffect'); // Remove blur when menu is closed
            }
        });
        ...
        document.querySelector('.send').addEventListener('click', function(event) {
            ...
            pageContent.classList.remove('blureffect'); // Remove blur effect
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const bodyMenu = document.querySelector('#bodyMenu');    // Сайдбар меню
        ...
        function toggleMenu() {
            ...
            if (screenWidth <= 1120) { // Только для экранов до 1120px
                ...
                menuButton.addEventListener('click', function(event) {
                    ...
                    bodyMenu.classList.toggle('show');   // Переключаем класс "show" для отображения меню
                ...
                menuButtonf.addEventListener('click', function(event) {
                    ...
                    sideFeed.classList.toggle('show');   // Переключаем класс "show" для отображения sideFeed
